...
module.exports = {
	...
	data: new SlashCommandBuilder()
		.setName('teto')
		.setDescription('Find a Kasane Teto gif using Tenor\'s API!'),
	async execute(interaction) {
		...
		const tenorSearch = await fetch("https://tenor.googleapis.com/v2/search?q=" + "kasane teto" + "&key=" + tenorKey + "&client_key=" + "DiscordBot" + "&limit=" + 1 + "&random=" + true);
